      ...
      <div className="text-white flex flex-col">
        <nav className="z-50">
          <div
            ...
            } px-[20%] w-full fixed mx-auto py-12 text-[18px] font-bold justify-between flex`}
          >
            <div>
              <span>Home</span>
        ...
        <Parallax pages={4}>
          <div>
              ...
              <div className="flex flex-row px-[20%]">
                <div className="flex flex-col">
                  ...
                  <span className="text-[24px] max-w-[48rem] mt-[18px]">
                    ...
                    hosting & databases, full development lifecycle which
                    involves prototyping, trialling, releasing, marketing and
                    showcasing.
                  </span>
                </div>
              </div>
            ...
            <ParallaxLayer offset={2.2} speed={0.5}>
              <div className="px-[20%]">
                <span className="text-[56px] font-bold mt-[32rem]">
                  Projects
                </span>
                  ...
                  <div className="card rounded-[12px] w-1/3 ml-4">
                    ...
                    <div className="card-content py-8 px-10  flex flex-col">
                      ...
                      <span className="mt-4">
                        ...
                        implementing features such as three.js,
            ...
            <ParallaxLayer offset={3.2} speed={2}>
              <div className="px-[20%]">
                <span className="text-[56px] font-bold mt-[24rem]">
                  Contact
                </span>
